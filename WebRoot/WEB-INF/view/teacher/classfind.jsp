			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<form id="classInfo" method="post">
						...
						<div class="form-group has-feedback">
							<input type="text"  name="classDep" disabled="disabled" class="form-control" placeholder="学院">
						</div>
						...
						<div class="form-group has-feedback">
							<input type="text"  name="className" disabled="disabled" class="form-control" placeholder="班级">
						</div>
						<div class="form-group has-feedback">
							<input type="text"  name="classTeacher" disabled="disabled" class="form-control" placeholder="教师">
						</div>
						<div class="row">
							<div class="col-xs-4">
							</div>
