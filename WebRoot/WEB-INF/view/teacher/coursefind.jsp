...
<body class="hold-transition skin-blue sidebar-mini">
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<form id="courseInfo" method="post">
						...
						<div class="form-group has-feedback">
							<input type="text" name="courseName" class="form-control"  disabled="disabled" placeholder="课程名">
						</div>
						<div class="form-group has-feedback">
							<input type="text" name="courseNum" class="form-control"  disabled="disabled" placeholder="课程学分">
						</div>
						<div class="form-group has-feedback">
							<input type="text" name="courseTime" class="form-control"  disabled="disabled" placeholder="课程学时">
						</div>
						<div class="row">
							<div class="col-xs-4">
							</div>
	...
	<script>
        ...
        + "<i class='fa fa-edit'></i> 详情</button></td>"
		+ "</tr>";
